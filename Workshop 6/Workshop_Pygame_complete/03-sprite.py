...
meteorBig_img = pg.image.load('source/img/meteor_big.png')
meteorMed_img = pg.image.load('source/img/meteor_med.png')
meteorSmall_img = pg.image.load('source/img/meteor_small.png')
...
for i in range(10):
    meteor = Meteor()
    meteor.rect.x,meteor.rect.y = random.randrange(0,width),0
